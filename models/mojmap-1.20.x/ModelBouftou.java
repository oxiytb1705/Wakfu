	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_rotation = head.addOrReplaceChild("head_rotation",
				CubeListBuilder.create().texOffs(40, 22)
						.addBox(-4.5F, -3.866F, -1.5F, 9.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(46, 11)
						.addBox(-5.3F, 0.3F, -2.3F, 1.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 47)
						.addBox(4.3F, 0.3F, -2.3F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(24, 53)
						.addBox(4.3F, -2.3F, -2.3F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 47)
						.addBox(4.3F, -4.3F, -2.3F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(46, 0)
						.addBox(-5.3F, -2.3F, -2.3F, 10.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 47)
						.addBox(-5.3F, -4.3F, -2.3F, 1.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(40, 33)
						.addBox(-4.7F, 0.3F, -2.3F, 10.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(40, 39)
						.addBox(-4.7F, 3.3F, -2.3F, 10.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 42)
						.addBox(-4.7F, -3.3F, -2.3F, 10.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(26, 44)
						.addBox(-4.7F, -4.3F, -2.3F, 10.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -2.0F, 0.0F));

		PartDefinition right_ear_cube = partdefinition.addOrReplaceChild("right_ear_cube",
				CubeListBuilder.create().texOffs(52, 44).addBox(-0.5F, -1.0F, -1.15F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.4F, 15.0F, -4.85F, 0.0F, 0.0F, 0.3054F));

		PartDefinition right_ear_cube2 = right_ear_cube.addOrReplaceChild("right_ear_cube2",
				CubeListBuilder.create().texOffs(0, 53).addBox(-1.0F, -1.2F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.2F, 0.0F, -0.15F, 0.0F, 0.0F, 0.3054F));

		PartDefinition left_ear_cube = partdefinition.addOrReplaceChild("left_ear_cube",
				CubeListBuilder.create().texOffs(8, 53).addBox(-2.2F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.75F, 15.0F, -5.0F, 0.0F, 0.0F, -0.3054F));

		PartDefinition left_ear_cube2 = left_ear_cube
				.addOrReplaceChild("left_ear_cube2",
						CubeListBuilder.create().texOffs(16, 53).addBox(-1.5F, -1.4F, -1.0F, 2.0F, 2.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3054F));

		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, -8.0F, -10.0F, 10.0F, 9.0F, 13.0F, new CubeDeformation(0.3F)).texOffs(0, 22)
		...
		PartDefinition front_left_leg = partdefinition.addOrReplaceChild("front_left_leg", CubeListBuilder.create()
				.texOffs(24, 48).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition front_right_leg = partdefinition.addOrReplaceChild("front_right_leg", CubeListBuilder.create()
				.texOffs(32, 48).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 21.0F, -4.0F));

		PartDefinition back_left_leg = partdefinition.addOrReplaceChild("back_left_leg", CubeListBuilder.create()
				.texOffs(40, 48).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 21.0F, 4.0F));

		PartDefinition back_right_leg = partdefinition.addOrReplaceChild("back_right_leg", CubeListBuilder.create()
				.texOffs(48, 48).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 21.0F, 4.0F));

		PartDefinition tail = partdefinition
				.addOrReplaceChild("tail",
						CubeListBuilder.create().texOffs(46, 4).addBox(-1.5F, -0.5864F, 0.0933F, 3.0F, 3.0F, 4.0F,
								new CubeDeformation(0.0F)),
